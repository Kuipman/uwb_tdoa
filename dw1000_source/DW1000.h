...
public:
	...
	*/
	...
	//DEBUG Function
	static void setPrintableDeviceIdentifier(byte data[LEN_DEV_ID]); 
	//End DEBUG
	...
	*/
	...
	/* KUIPERS FUNCTIONS */
	static void setNewDeviceSettings_Kuipers();
	static void activateLEDs();
	static void activateLEDsV2();
...
//private:
	...
	static byte _deviceID[LEN_CHAN_CTRL];
